#!/usr/bin/env python3
"""Export ERA5 divergence to per-hour RGB PNG files by pressure level.
...
Outputs:
  ...
  ../public/divergence-rg/divergence_ranges.json
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Export ERA5 divergence to PNG RGB frames by pressure level."
    )
    parser.add_argument(
        "--input",
